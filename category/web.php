...
else
{
	while($row = mysqli_fetch_array($query))
	{
		...
		$query2 = mysqli_query($connection,"SELECT username,photo FROM users WHERE id='$by'");
		while($row2 = mysqli_fetch_array($query2))
		{
			$name=$row2['username'];
            $photo=$row2['photo'];
            echo '<img style="border-radius:50px" src="../images/'.$photo.'" width="50" height="50"/>';
...
$dbh=new PDO("mysql:host=localhost;dbname=tdf","root","");
