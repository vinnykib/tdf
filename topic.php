...
else
{
    ...
    $cat=$row['topic_cat'];
    $by=$row['topic_by'];
    $query4=mysqli_query($connection,"SELECT username,photo FROM users WHERE id='$by'");
  ...
  <br><br>
   <img style='border-radius:50px' src='./images/$photo' width='50' height='50'/><br>
...
else
{
    ...
    echo"<hr style='width:51.5%; float:left; size:2px; margin-left:0px'><br><br>";
		...
		$query3=mysqli_query($connection,"SELECT username,photo FROM users WHERE id='$by'");
		$row3= mysqli_fetch_assoc($query3);
		$name=$row3['username'];
    $photo=$row3['photo'];

  echo "<div class='divigr'><br><br>";
  echo '<img style="border-radius:50px" src="./images/'.$photo.'" width="50" height="50"/><br>';
