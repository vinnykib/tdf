...
<a href="profile_update.php"><button style="font-size: 25px; margin-left:500px;">Edit Profile</button></a>
<a href="update_password.php"><button style="font-size: 25px; margin-left:200px;">Update Password</button></a>
</div>
</div>
<br><br><br><br>
...
$query=mysqli_query($connection,"SELECT * FROM topics WHERE topic_by='$id' ORDER BY topic_id DESC");
